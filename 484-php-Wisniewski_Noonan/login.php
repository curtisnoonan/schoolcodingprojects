...
<body>
    <?php
        ...
        {
        echo "<p>Welcome back $username! Login was successful</p>"; //when user logs in successfully
        echo "\n";
        ...
        echo "<tr>
            ...
            while($singleRow = mysqli_fetch_row($gettingTable)) //taking the table row by row
            {
        ...
        {
            echo "Incorrect username or password.";
            echo "Please go back and input the password"; //instead of the above, user is asked to go back
        }
